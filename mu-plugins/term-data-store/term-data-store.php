...
/**
 * Takes a post object (or ID) and taxonomy slug
 *
 * First $post is run through get_related_term() to get related term. If
 * it's not null then the term ID and $taxonomy is passedto wp_delete_term().
 *
 ...
 * @param string $taxonomy  The taxonomy slug
 * 
 * @return bool Whether the realted term is deleted or not
 *
 */
function delete_related_term( $post, $taxonomy ) {
