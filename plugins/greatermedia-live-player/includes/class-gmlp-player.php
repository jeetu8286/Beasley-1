...
class GMLP_Player {
	...
	public static function enqueue_scripts() {
		...
		wp_localize_script( 'gmlp-js', 'gmr', array( 'logged_in' => is_gigya_user_logged_in(), 'callsign' => $callsign, 'streamUrl' => $vast_url, 'wpLoggedIn' => is_user_logged_in(), 'homeUrl' => $home_url, 'popup_url' => home_url( self::$endpoint_slug ), 'is_popup' => self::$is_loading_popup ) );
	}
