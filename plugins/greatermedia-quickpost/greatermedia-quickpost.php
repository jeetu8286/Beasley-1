...
class GMR_QuickPost {
	...
	public function render_tool_box() {
		...
		?><div class="tool-box">
			<p>Quick Live Link is a bookmarklet: a little app that runs in your browser and lets you quickly create live links from content around the web.</p>

			<p class="description">
								Drag-and-drop the following link to your bookmarks bar or right click it and add it to your favorites for a shortcut to create live links from any content on the web.
			</p>
