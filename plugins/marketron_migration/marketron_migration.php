...
if ( defined( 'WP_CLI' ) and WP_CLI and is_readable( GMEDIA_PATH . 'includes/class-gmediamigration.php' ) ) {
	include_once GMEDIA_PATH . 'includes/class-gmediamigration.php';
}

if( is_readable( GMEDIA_PATH . 'includes/class-MigrationPostTypes.php' ) ) {
	include_once GMEDIA_PATH . 'includes/class-MigrationPostTypes.php';
}
