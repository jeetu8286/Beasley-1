...
class SeriouslySimplePodcasting {
	...
	//
	private $episode_token = GMP_CPT::EPISODE_POST_TYPE;
	...
	public function __construct( $file ) {
		...
		if ( is_admin() ) {
			...
			add_filter( 'manage_edit-' . $this->episode_token . '_columns', array( $this, 'register_custom_column_headings' ), 10, 1 );
	...
	public function register_post_type() {
        ...
        register_taxonomy( 'series', array( 'episode' ), array( 'hierarchical' => true , 'label' => 'Series' , 'singular_label' => 'Series' , 'rewrite' => true) );
	...
	public function meta_box_setup () {
		add_meta_box( 'episode-data', __( 'Episode Details' , 'ss-podcasting' ), array( $this, 'meta_box_content' ), GMP_CPT::EPISODE_POST_TYPE, 'normal', 'high' );
