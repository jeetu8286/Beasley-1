   ...
   /**
    ...
    public function admin_load_js($hook_suffix) {
        ...
        if ($hook_suffix === 'user-edit.php') {
            ...
            wp_register_script('ure-pro-user-profile-plugins', plugins_url('/js/pro/ure-pro-user-profile-plugins.js', URE_PLUGIN_FULL_PATH));
            wp_enqueue_script('ure-pro-user-profile-plugins');
            wp_localize_script('ure-pro-user-profile-plugins', 'ure_pro_data_plugins', array(
