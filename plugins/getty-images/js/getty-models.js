...
(function($) {
	...
	var api = {
		...
		endpoints: {
			...
			GetActiveProductOfferings: 'https://connect.gettyimages.com/v1/data/GetActiveProductOfferings',
			GetAllProductOfferings: 'https://connect.gettyimages.com/v1/data/GetAllProductOfferings',
			...
			GetLargestImageDownloadAuthorizations: 'https://connect.gettyimages.com/v1/download/GetLargestImageDownloadAuthorizations',
			...
			GetEventDetails: 'https://connect.gettyimages.com/v1/search/GetEventDetails'
		},
