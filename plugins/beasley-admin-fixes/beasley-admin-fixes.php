...
function fix_new_post_checkbox_defaults() {
	$version = defined( 'EDIT_FLOW_VERSION' ) ? EDIT_FLOW_VERSION : '';
	wp_enqueue_script( 'new-post-checkbox-js', plugins_url( 'beasley-admin-fixes/js/checkbox.js' ), 'jquery', $version, true );
}
