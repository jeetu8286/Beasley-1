...
class SyndicationCPT {
	...
	public static $supported_subscriptions = array( 'post', 'page', 'content-kit', 'contest', 'survey', 'gmr_gallery','listicle_cpt' , 'affiliate_marketing' );
	...
	public function register_collections_taxonomy() {
		...
		register_taxonomy( 'collection', array( 'post', 'announcement', 'content-kit', 'gmr_gallery', 'affiliate_marketing', 'listicle_cpt' ), $args );
	}
