			...
			<div class="highlights__community">
				...
				<div class="highlights__community--item">
					...
					<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
						...
						<div class="highlights__community--thumb" style='background-image: url(<?php beasley_post_thumbnail_url( null, true, 336, 224 ); ?>)'></div>
					...
					<div class="highlights__event--item">
						<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
							<?php if ( has_post_thumbnail() ) : ?>
								<div class="highlights__event--thumb" style='background-image: url(<?php beasley_post_thumbnail_url( null, true, 336, 224 ); ?>)'></div>
							<?php endif; ?>
