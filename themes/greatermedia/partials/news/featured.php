			...
			<?php if ( $hp_featured_query->have_posts() ) : $hp_featured_query->the_post(); ?>
				<div class="featured__article">
					<a href="<?php the_permalink(); ?>" class="featured__article--link">
						<div class="featured__article--image" style="background-image: url(<?php bbgi_post_thumbnail_url( null, true, 400, 250 ); ?>);"></div>
	...
	?>
		<div class="featured__article--secondary">
			<?php
				...
				<div class="featured__article">
					<a href="<?php the_permalink(); ?>" class="featured__article--link">
						<div class="featured__article--image" style="background-image: url(<?php bbgi_post_thumbnail_url( null, true, 198, 110 ); ?>);"></div>
						<div class="featured__article--content">
							<div class="featured__article--heading">
								<?php the_title(); ?>
							</div>
			...
			?>
					<div class="featured__content--block">
						<a href="<?php the_permalink(); ?>" class="featured__content--link">
							<div class="featured__content--image" style="background-image: url(<?php bbgi_post_thumbnail_url( null, true, 198, 110 ); ?>);"></div>
