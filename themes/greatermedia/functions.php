...
function greatermedia_scripts_styles() {
	...
	if ( is_page( 'style-guide' ) ) {
		...
		wp_enqueue_style( 'gm-styleguide', get_template_directory_uri() . "/assets/css/gm_styleguide{$postfix}.css", array( 'open-sans', 'droid-sans', 'font-awesome' ), GREATERMEDIA_VERSION );
	} else {
