			...
			<div id="live-player" class="live-player__container">
				...
				<?php } else { ?>
					<div id="on-air" class="on-air">
						<span class="on-air__title">On Air:</span><span
							class="on-air__show">Preston and Steve Show</span>
					</div>
					<div class="live-stream">
						<div class="live-stream__login--actions">
							<a href="<?php echo esc_url( home_url( '/members/login' ) ); ?>"
							   class="live-stream__btn--login"><span
									class="live-stream__btn--label"><?php _e( 'Login to Listen Live', 'greatermedia' ); ?></span></a>
						</div>
						<div class="live-stream__status">
							<a href="<?php echo esc_url( home_url( '/members/login' ) ); ?>"
							   id="live-stream__listen-now"
