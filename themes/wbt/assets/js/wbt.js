 ...
 GMCLT.Traffic = function()
  {
	...
	var getTrafficIncidents = function() {
		...
		$.getJSON('http://site.gmclt.com/api/Traffic.cfc?method=getActiveIncidents&callback=?',
	...
	var	getTrafficCameras = function() {
		...
		$.getJSON('http://site.gmclt.com/api/Traffic.cfc?method=getActiveCameras&callback=?',
