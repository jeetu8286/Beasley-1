        ...
        <section class="content">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'article cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
                ...
                <section class="article__content" itemprop="articleBody">
					...
					<!-- @todo : Update to HTTPS when supports --><iframe src="http://www.centraljerseysnow.com/members/closings/index.cfm" width="590" height="3000" scrolling="auto" frameborder="0"></iframe>
                </section>
