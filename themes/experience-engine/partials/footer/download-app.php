<div class="download">
	...
	<?php if ( ee_has_publisher_information( 'itunes_app' ) ) : ?>
		<a href="<?php echo esc_url( ee_get_publisher_information( 'itunes_app' ) ); ?>" aria-label="Download on the App Store" target="_blank" rel="noopener noreferrer">
	...
	<?php if ( ee_has_publisher_information( 'play_app' ) ) : ?>
		<a href="<?php echo esc_url( ee_get_publisher_information( 'play_app' ) ); ?>" aria-label="Download on the Google Play" target="_blank" rel="noopener noreferrer">
