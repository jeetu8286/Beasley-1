<div class="connect">
	...
	<ul class="social">
		<?php if ( ee_has_publisher_information( 'facebook' ) ) : ?>
			<li>
				<a href="#" aria-label="Go to station's Facebook page">
		...
		<?php if ( ee_has_publisher_information( 'twitter' ) ) : ?>
			<li>
				<a href="#" aria-label="Go to station's Twitter page">
		...
		<?php if ( ee_has_publisher_information( 'instagram' ) ) : ?>
			<li>
				<a href="#" aria-label="Go to station's Instagram page">
		...
		<?php if ( ee_has_publisher_information( 'youtube' ) ) : ?>
			<li>
				<a href="#" aria-label="Go to station's Youtube page">
