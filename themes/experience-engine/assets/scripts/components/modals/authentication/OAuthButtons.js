...
class OAuthButtons extends PureComponent {
	...
	render() {
		...
		return (
			<div>
				<button className="button auth-button -twitter" type="button" onClick={self.onTwitterLogin}>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 612 612" width="20" height="20">
				...
				<button className="button auth-button -facebook" type="button" onClick={self.onFacebookLogin}>
				...
				<button className="button auth-button -google" type="button" onClick={self.onGoogleLogin}>
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 491.858 491.858" width="20" height="20">
