...
const Share = () => (
	<div className="share">
		<span>Share</span>
		<button className="facebook" onClick={handleFacebookClick} aria-label="Share this on Facebook">
		...
		<button className="twitter" onClick={handleTwitterClick} aria-label="Share this on Twitter">
