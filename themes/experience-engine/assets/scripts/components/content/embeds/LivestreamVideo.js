...
class LivestreamVideo extends PureComponent {
	...
	componentDidMount() {
		...
		script.setAttribute( 'src', `//livestream.com/assets/plugins/referrer_tracking.js?t=${+new Date()}` );
	...
	render() {
		...
		return (
			<div className="lazy-video">
				<iframe id={embedid} src={src} title="Watch Video" frameBorder="0" scrolling="no" allowFullScreen />
			</div>
		);
	}
