...
export const showSignInModal = ( payload = {} ) =>
	showModal( SIGNIN_MODAL, payload );

export const showSignUpModal = ( payload = {} ) =>
	showModal( SIGNUP_MODAL, payload );

export const showRestoreModal = ( payload = {} ) =>
	showModal( RESTORE_MODAL, payload );

export const showDiscoverModal = ( payload = {} ) =>
	showModal( DISCOVER_MODAL, payload );
