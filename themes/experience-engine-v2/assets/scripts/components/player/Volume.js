		...
		return (
			<div ref={this.volumeRef} className="controls-volume">
				...
				>
					...
					>
						<path
							d="M4.79511 4.99539L9.99617 0.595406C10.2092 0.470276 10.4573 0.468062 10.6725 0.589772L10.9187 0.154558L10.6725 0.589774C10.8976 0.717097 11.0322 0.945565 11.0322 1.21398V16.4703C11.0322 16.7387 10.8977 16.9669 10.673 17.0938C10.5648 17.1549 10.4507 17.1836 10.3382 17.1838C10.2239 17.1837 10.107 17.1534 9.99787 17.0895L4.80119 12.316L4.65764 12.1842L4.46272 12.1843L0.5 12.1861V5.11367H4.47218H4.6553L4.79511 4.99539ZM10.0075 17.0983L10.0072 17.098L10.0075 17.0983Z"
							fill="#707070"
							style={colors}
						/>
						<path
				...
				<div className="ee-range-input">
					...
					>
						<label className="screen-reader-text" htmlFor="audio-volume">
							Volume:
						</label>
