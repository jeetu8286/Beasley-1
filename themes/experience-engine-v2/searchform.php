<?php $aria_label = isset($args['aria_label']) && $args['aria_label'] != "" ? $args['aria_label'] : "" ; ?>
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<label for="search-q" id="q" class="screen-reader-text">Search for:</label>
	<input id="search-q" type="search" class="search-field <?php echo $aria_label; ?>" name="s" value="<?php echo get_search_query( true /* <-- to escape? */ ); ?>" placeholder="Search" style="display: none;">
	<button type="submit" class="search-submit" id="wp-search-submit" aria-label="Submit search">
