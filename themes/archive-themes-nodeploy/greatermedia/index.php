		...
		<section class="content">
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article" itemscope
					...
					<header class="entry-header">
						...
						<time datetime="<?php the_time( 'c' ); ?>"
						      class="entry__date"><?php the_time( 'F j, Y' ); ?></time>
			...
			<?php endwhile; ?>
				...
				<div class="posts-pagination">
					...
					<div
						class="posts-pagination--previous"><?php next_posts_link( '<i class="fa fa-angle-double-left"></i>Previous' ); ?></div>
					<div
						class="posts-pagination--next"><?php previous_posts_link( 'Next<i class="fa fa-angle-double-right"></i>' ); ?></div>
