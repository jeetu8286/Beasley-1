        ...
        <section class="content">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'article cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
                ...
                <section class="article__content" itemprop="articleBody">
                    ...
                    <iframe src="http://www.sigalert.com/Custom/Map.asp?partner=WRAT-FM&lat=40.31584&lon=-74.28114&z=2&th=brown&ap=left&sp=p&urqs=1" width="570" height="665" style="border:1px solid #000000" frameborder="0" scrolling="auto" marginwidth="0" marginheight="0" allowtransparency="true"></iframe>
