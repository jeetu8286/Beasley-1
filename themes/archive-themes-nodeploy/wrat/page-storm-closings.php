        ...
        <section class="content">
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class( 'article cf' ); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
                ...
                <section class="article__content" itemprop="articleBody">
                    ...
                    <p style="text-align: center;"><strong>Is your organization not a member of 95.9 The Rat's storm closings system yet? <a href="http://www.centraljerseysnow.com/members/signupform.cfm"><br />SIGN UP NOW!</a></strong></p>
