 ...
 */
function wmgc_add_gtm_script() {
	?><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
	new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
	j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
	'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
	})(window,document,'script','dataLayer','GTM-KRWQX8');</script><?php
}
add_action( 'wp_head', 'wmgc_add_gtm_script' );

/**
 * Add Google Tag Manager iframe after body.
 */
function wmgc_add_gtm_iframe() {
	?><noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-KRWQX8" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript><?php
}
add_action( 'beasley_after_body', 'wmgc_add_gtm_iframe' );
