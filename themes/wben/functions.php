...
function wben_scripts_styles() {
	...
	wp_enqueue_style( 'wben', get_stylesheet_directory_uri() . "/assets/css/wben{$postfix}.css", array(), GREATERMEDIA_VERSION );

	/* DISABLING DUE TO SIMPLIFI NETWORK ISSUE - WILL ENABLE ONCE FIXED - STEVE MEYERS - 11/13/15 */
	/* wp_enqueue_script( 'simpli-fi', 'http://i.simpli.fi/dpx.js?cid=23418&action=100&segment=benfem&m=1&sifi_tuid=7534', array(), null, true ); */
}
